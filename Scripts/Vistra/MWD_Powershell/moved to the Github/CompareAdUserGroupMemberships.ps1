...
#userList work:  glowackik! jablonskik! glomskip! wojewodam!
#userList trinity:  adm.mwd! adm.bkl! adm.kgc! adm.jbl!


#$access = Compare-AdUsersGroupMembership adm.mwd adm.kgc trinitycs
Compare-AdUsersGroupMembership  Katja.Patzwald Larissa.Schimpf work.local | Out-GridView | export-csv -Delimiter ";" -NoTypeInformation -Encoding UTF8 -Path "Compare Michał Kamil Work.csv"
